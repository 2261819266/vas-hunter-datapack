...
execute if score runnerDiedToBe vas.rule matches 0 run gamemode spectator
execute if score runnerDiedToBe vas.rule matches 1 run title @s title "\u00a7cYou are Hunter now!"
execute if score runnerDiedToBe vas.rule matches 1 run team join hunter
