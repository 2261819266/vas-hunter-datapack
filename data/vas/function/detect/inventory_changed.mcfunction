...
# execute if items entity @s player.cursor *[custom_data~{controller:1b}, item_name={translate:"item.vas.controller"}] run function vas:control/show
...
advancement revoke @s only vas:detect/inventory_changed
